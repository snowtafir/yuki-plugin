 ...
 */
function generateRealisticMouseTrack(): number[][] {
  const tracks: number[][] = [];
  const now = Date.now();
 ...
 */
function rsaEncrypt(data, publicKeyDer: any) {
 ...
 */
async function encryptData(jsonData: string) {
 ...
 */
export async function genBdPayload() {
 ...
 */
export async function getRidFromBd(X_CSRF_TOKEN: string) {
