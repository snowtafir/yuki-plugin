...
export type RendersType = <ComponentsType extends Record<string, React.FC<any> | React.ComponentClass<any>>>(Components: ComponentsType) => <TKey extends keyof ComponentsType>(
/**
 * 组件 key
 */
key: TKey, 
 ...
 * 文件名。默认为组件key
 */
name?: string) => Promise<false | Buffer>;
