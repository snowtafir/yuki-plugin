...
const Version = (await import('./components/version/Version.tsx')).default;
const Help = (await import('./components/help/Help.tsx')).default;
const LoginQrcode = (await import('./components/loginQrcode/Page.tsx')).default;
