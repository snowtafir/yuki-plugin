...
const Version = (await import('./src/components/version/Version.tsx')).default;
const Help = (await import('./src/components/help/Help.tsx')).default;
const LoginQrcode = (await import('./src/components/loginQrcode/Page.tsx')).default;
...
export default defineConfig({
  routes: {
    ...
    '/version': {
      component: <Version {...versionProps} />
    },
    '/help': {
      component: <Help {...helpProps} />
    },
    '/login': {
      component: <LoginQrcode {...LoginProps} />
    }
  }
});
